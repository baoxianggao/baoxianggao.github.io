...
### 9. 博客目录
文件: `blog/index.html`、`blog/post.html`

- 博客目录页：最近发布、标签筛选、草稿摘要
- 文章详情页：元信息、正文渲染、提纲侧栏、复制链接、导出 HTML
- 博客内容基于浏览器本地存储，可与博客工作台联动

### 10. 博客工作台
文件: `tools/blog-studio.html`

- 博客文章库（草稿 / 已发布）
- 一键生成结构化文章模板（指南 / 日志 / 构建记录 / 评测）
- 标题、Slug、摘要、标签、语言、封面风格管理
- Markdown 编辑 + 实时预览
- 支持发布到博客目录、本地导出 `MD/HTML`

### 11. 密码实验室
文件: `tools/password-lab.html`
